...
data_loader = dataLoaderUSR(DATA_PATH="/content/drive/MyDrive/Review-2/SRDRM/USR-248", SCALE=4)
...
#####################################################################
# compile model
model.load_weights("/content/checkpoints/USR_4x/srdrm/model_16_.h5")
