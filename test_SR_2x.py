...
data_dir = "/content/drive/MyDrive/Review-2/SRDRM/data/test/lr_2x"
...
#ckpt_name =  "model_4_"
# checkpoint_dir  = os.path.join("/content/checkpoints/USR_2x/srdrm/", model_name) 
model_h5 = '/content/checkpoints/USR_2x/srdrm/model_40_.h5' 
model_json = '/content/checkpoints/USR_2x/srdrm/model_40_.json'
# sanity
...
samples_dir = os.path.join("/content/drive/MyDrive/Review-2/SRDRM/data/output/2x/", model_name)
